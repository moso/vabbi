 ...
 */
 ...
 (function ($) {
     ...
     h.defaults = {
         axis: 'xy',
         duration: parseFloat($.fn.jquery) >= 1.3
             ? 0
             : 1,
         limit: true
     };
     ...
     $.fn.scrollTo = function (e, f, g) {
         ...
         return this
             ...
             .each(function () {
                 ...
                 function animate(a) {
                     $elem
                         .animate(attr, f, g.easing, a && function () {
                             a.call(this, e, g)
                         })
                 }
             })
 ...
 (function ($, window, document, undefined) {
     ...
     OnePageNav.prototype = {
         ...
         init: function () {
             ...
             // Introduce defaults that can be extended either globally or using an object
             // literal.
             ...
             self
                 .$nav
                 .on('click.onePageNav', $.proxy(self.handleClick, self));
             ...
             self
                 .$win
                 .on('resize.onePageNav', $.proxy(self.getPositions, self));
